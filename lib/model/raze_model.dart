...
//
//     final razeModel = razeModelFromJson(jsonString);

import 'dart:convert';

RazeModel razeModelFromJson(String str) => RazeModel.fromJson(json.decode(str));

String razeModelToJson(RazeModel data) => json.encode(data.toJson());
...
class RazeModel {
    ...
    factory RazeModel.fromJson(Map<String, dynamic> json) => RazeModel(
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        characterTags: List<String>.from(json["characterTags"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "characterTags": List<dynamic>.from(characterTags.map((x) => x)),
