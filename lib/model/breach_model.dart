...
//
//     final breachModel = breachModelFromJson(jsonString);

import 'dart:convert';

BreachModel breachModelFromJson(String str) => BreachModel.fromJson(json.decode(str));

String breachModelToJson(BreachModel data) => json.encode(data.toJson());
...
class BreachModel {
    ...
    factory BreachModel.fromJson(Map<String, dynamic> json) => BreachModel(
        status: json["status"],
